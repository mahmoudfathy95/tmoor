...
class CouponController extends Controller
{
    ...
    {
        $coupons = Coupon::all();
        return view('ordermodule::coupons.index',compact('coupons'));
    }
    ...
    {
        return view('ordermodule::coupons.create');
    }
    ...
    {
        $data = $request->only('code','value','type','date_from','date_to');
    ...
    {
        $item = Coupon::find($id);
        return view('ordermodule::coupons.edit',compact('item'));
    }
