        ...
        <div class="col-md-12">
            ...
            <div class="card card-primary">
                <div class="card-header">
                    <h3 class="card-title">اضافة كوبون</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <form id="create1" role="form" action="{{url('dashboard/coupon')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                    <div class="row">
                     <div class="form-group col-md-6">
                            <label class="form-control-label">الكود: <span class="tx-danger">*</span></label>
                            <input class="form-control tab-child " type="text" name="code" value="{{old('code')}}" placeholder="الكود">
                            @error('code')
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input class="form-control tab-child" type="text" name="value" value="{{old('value')}}" placeholder="القيمة">
                            @error('value')
                                <div style="background:transparent;margin:0;padding:0" class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input class="form-control tab-child" type="date" name="date_from" value="{{old('date_from')}}" >
                            @error('date_from')
                                <div style="background:transparent;margin:0;padding:0" class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input class="form-control tab-child" type="date" name="date_to" value="{{old('date_to')}}" >
                            @error('date_to')
                                <div style="background:transparent;margin:0;padding:0" class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>
