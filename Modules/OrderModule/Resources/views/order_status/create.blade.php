        ...
        <div class="col-md-12">
            ...
            <div class="card card-primary">
                <div class="card-header">
                    <h3 class="card-title">اضافة حالة طلب</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <form id="create1" role="form" action="{{route('order_status.store')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                    <div class="row">
                     ...
                     <div class="form-group col-md-3">
                            ...
                            <input class="form-control tab-child " type="text" name="ar[name]" value="{{old('ar[name]')}}" placeholder="">
                            @error('ar[name]')
                                <div style="background:transparent;margin:0;padding:0" class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input class="form-control tab-child" type="text" name="en[name]" value="{{old('en[name]')}}" placeholder="">
                            @error('en[name]')
                                <div style="background:transparent;margin:0;padding:0" class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>
