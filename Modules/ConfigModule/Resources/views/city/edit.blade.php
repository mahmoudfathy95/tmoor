...
@section('content')
        ...
        <div class="col-md-12">
            ...
            <div class="card card-primary">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form id="create1" role="form" action="{{route('city.update',$item->id)}}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('put')
                    <div class="card-body">
                    <div class="row">
                     <div class="form-group col-md-4">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input class="form-control tab-child" type="text" name="shipping_amount" value="{{$item->shipping_amount}}" placeholder="{{__('productmodule::category.shipping_amount')}}">
