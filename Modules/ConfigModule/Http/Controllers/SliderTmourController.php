...
class SliderTmourController extends Controller
{
    use UploaderHelper;
    /**
    ...
    public function index()
    {
        ...
        return view('configmodule::slidertmour.index',compact('sliders'));
    }
    ...
    public function create()
    {
        ...
        return view('configmodule::slidertmour.create',compact('categories','products'));
    }
    ...
    public function store(Request $request)
    {
       ...
       $data['type']=2;
        ...
        return redirect('dashboard/sliderTmour');
    }
    ...
    public function edit($id)
    {
        ...
        $products = Product::all();
        $item = Slider::find($id);
        return view('configmodule::slidertmour.edit',compact('categories','products','item'));
    }
