...
@section('title')
{{__('productmodule::category.careatcategroy')}}
@endsection
@section('page_header')
{{__('productmodule::category.careatcategroy')}}
@endsection
        ...
        <div class="col-md-12">
            ...
            <div class="card card-primary">
                <div class="card-header">
                    <h3 class="card-title">{{__('productmodule::category.careatcategroy')}}</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <form id="create1" role="form" action="{{url('dashboard/category')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                    <div class="row">
