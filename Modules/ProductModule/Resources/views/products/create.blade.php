...
@section('title')
{{__('productmodule::category.createproduct')}}
@endsection
@section('page_header')
{{__('productmodule::category.createproduct')}}
@endsection
        ...
        <div class="col-md-12">
            ...
            <div class="card card-primary">
                <div class="card-header">
                    <h3 class="card-title">{{__('productmodule::category.createproduct')}}</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <form id="create1" role="form" action="{{url('dashboard/products')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                    <div class="row">
                     <div class="form-group col-md-6">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input class="form-control tab-child " type="number" min="0" name="quantity" value="0" placeholder="{{__('productmodule::category.quantity')}}">
                            @error('quantity')
                                <div style="background:transparent;margin:0;padding:0" class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input class="form-control tab-child" type="number" min="0" name="value" value="0" placeholder="{{__('productmodule::category.discount')}}">
                            @error('value')
                                <div style="background:transparent;margin:0;padding:0" class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>
                         ...
                         <div class="form-group col-md-6">
                            ...
                            <input class="form-control tab-child" type="number" min="0" name="number" value="0" placeholder="العدد">
                            @error('number')
                                <div style="background:transparent;margin:0;padding:0" class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>
